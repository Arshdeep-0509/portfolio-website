  ...
  return (
    ...
    >
      <Tilt
        ...
        className="bg-tertiary p-5 rounded-2xl w-full h-[500px] sm:h-[520px] md:h-[550px] flex flex-col"
      >
        <div className="relative w-full h-[180px] sm:h-[200px] md:h-[230px] flex-shrink-0">
          <img
            src={image}
            alt="project_image"
          ...
          <div className="absolute inset-0 flex justify-end items-start gap-2 m-3 card-img_hover">
            {live_link && (
              <div
                ...
                className="live-link-container black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
            ...
            {source_code_link && (
              <div
                ...
                className="github-icon-container black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
        ...
        <div className="mt-5 flex-shrink-0 flex-grow flex flex-col">
          <h3 className="text-white font-bold text-[20px] sm:text-[22px] md:text-[24px]">{name}</h3>
          <p className="mt-2 text-secondary text-[12px] sm:text-[13px] md:text-[14px] flex-grow overflow-hidden" style={{
            display: '-webkit-box',
            WebkitLineClamp: 3,
...
const Works = () => {
  ...
  return (
    <>
      ...
      <div className="works-container mt-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-center gap-5">
        {projects.map((project, index) => (
          <div key={`project-${index}`} className="project-card w-full sm:w-full md:w-[360px] lg:w-[360px]">
